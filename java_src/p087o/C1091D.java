...
public class C1091D extends RadioButton implements InterfaceC0403t, InterfaceC0404u {

    /* renamed from: f */
    public final C0958c f4453f;

    /* renamed from: g */
    public final C0913b f4454g;

    /* renamed from: h */
    public final C1134Z f4455h;

    /* renamed from: i */
    public C1192v f4456i;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1091D(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, R.attr.radioButtonStyle);
        AbstractC1127V0.m2746a(context);
        AbstractC1125U0.m2741a(this, getContext());
        C0958c c0958c = new C0958c(this);
        this.f4453f = c0958c;
        c0958c.m2442d(attributeSet, R.attr.radioButtonStyle);
        C0913b c0913b = new C0913b(this);
        this.f4454g = c0913b;
        c0913b.m2343k(attributeSet, R.attr.radioButtonStyle);
        C1134Z c1134z = new C1134Z(this);
        this.f4455h = c1134z;
        c1134z.m2760f(attributeSet, R.attr.radioButtonStyle);
        getEmojiTextViewHelper().m2819b(attributeSet, R.attr.radioButtonStyle);
    }

    private C1192v getEmojiTextViewHelper() {
        if (this.f4456i == null) {
            this.f4456i = new C1192v(this);
        }
        return this.f4456i;
    }
    ...
    public final void drawableStateChanged() {
        ...
        C0913b c0913b = this.f4454g;
        if (c0913b != null) {
            c0913b.m2333a();
        }
        C1134Z c1134z = this.f4455h;
        if (c1134z != null) {
            c1134z.m2757b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f4455h.m2758d();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f4455h.m2759e();
    }
    ...
    @Override // android.widget.CompoundButton
    public void setButtonDrawable(int i) throws NoSuchFieldException, SecurityException {
